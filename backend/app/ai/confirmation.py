...
_AGREEMENT = (
    ...
    "тасдик мекунем",
    "ха тасдик мекунам",
    # Khujand: "рост" (right, true) is the northern "верно"
    "рост",
    "рост аст",
    "ха рост",
    "хамааш рост",
...
_HEDGE = (
    ...
    "ну",
    "типа",
    # TG (03 §5), folded — with the Khujand spellings ("фикр мекнам", "намедонм") and "мумкин"
    # ("maybe"): at the summary "мумкин" is a doubt, not a yes.
    "шояд",
    "эхтимол",
    "балки",
    "мумкин",
...
_WEAK_ACK = (
    ...
    "майли",
    "маъкул",
    # Khujand "ok": "боша" (= бошад, "fine"), "нағз" ("good")
    "боша",
    "нагз",
)
...
_DETAIL_STEMS = (
    ...
    "килограмм",
    "ширин",
    # the cinnamon rolls and their flavours: "да, фисташковые" names what to change
    "синнамон",
    "синамон",
    "синабон",
    "булочк",
